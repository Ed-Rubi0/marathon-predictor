...
with st.sidebar:
    try:
        st.image(
            "https://javiercalvo.run/wp-content/uploads/2024/04/logo-kilometros-entrenamiento.png",
            width=210,
        )
    except Exception:
        st.markdown(f"### 🏃 Kilómetros de Entrenamiento")
...
<div class="app-footer">
  <strong>Kilómetros de Entrenamiento × Sport Science</strong><br>
